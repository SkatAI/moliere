...
def home_page():
    ...
    st.markdown(
        "Bienvenue sur [Molière.love](./), le site avec la traduction des pièces de Molière en langue moderne."
    )
    st.write(
    ...
    st.write(
        "Ok, ok, bon Molière c'est sympa, surtout quand on voit la pièce jouée sur scène par des bons acteurs. "
    )
    st.write(
        "Mais Molière, en classe c'est plutôt galère. Et faut bien le dire souvent incompréhensible. "
    )
